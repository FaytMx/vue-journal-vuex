<template>
  <div class="entry-container mb-3 pointer p-2" @click="$router.push({name: 'entry', params: {id:10}})">
    ...
    <div class="entry-description">
      ...
      temporibus libero ullam quas quo debitis, fuga alias architecto ab
      exercitationem officiis nesciunt suscipit asperiores amet similique!
      Earum, laudantium cum!
    </div>
  </div>
</template>
